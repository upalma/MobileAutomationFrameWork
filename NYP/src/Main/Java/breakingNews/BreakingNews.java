...
public class BreakingNews extends Base {
    @FindBy(id = "br.com.golmobile.nypost:id/logo_header") WebElement newYorkPost;
    @FindBy(xpath = "//android.widget.ImageButton[@content-desc=\"Menu\"]\n") WebElement hamBurger;
    @FindBy(id = "br.com.golmobile.nypost:id/turn_on_notifications_item") WebElement notification;
    @FindBy(id = "br.com.golmobile.nypost:id/headline_text_view") WebElement firstHeadLine;
